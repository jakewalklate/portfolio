...
A more literal example may be that of CPU architectures, to the end user who never touches the silicon whether a device is ARM or x86 is irrelevant and not noticable (in most cases), as the end program running looks identical.
