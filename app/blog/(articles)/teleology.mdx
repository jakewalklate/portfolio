...
The force that creates the universe, and the way of life for humans that leads to prosperity share the same origin, the same atomic definition: **it is Holy**.
