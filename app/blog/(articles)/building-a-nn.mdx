...
First I defined the linear calcuation for the perceptron

`v=wx`

Then the acitvation function to make it non-linear
...
Our loss function and it's derivative are describing how incorrect our networks output is peforming.
