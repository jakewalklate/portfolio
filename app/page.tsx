...
export default function Home() {
    ...
    <main className="flex flex-col items-center justify-center pt-24 pb-20 px-6 relative max-w-5xl mx-auto w-full">
      ...
      <section className="w-full space-y-8 text-center sm:text-left py-12 border-b border-zinc-800/50">
        ...
        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight text-white drop-shadow-[0_0_35px_rgba(255,255,255,0.15)] -mt-1 mb-1.5">
          <span className="opacity-80">Jake Walklate</span>
        </h1>
          ...
          <div className="space-y-6">
            <div className="p-8 rounded-2xl bg-zinc-900/50 border border-white/5 hover:border-white/10 transition-colors">
              ...
              <ul className="space-y-2 text-zinc-400">
                <li><a target="_blank" href="https://linkedin.com/in/jakewalklate" className="hover:text-white transition-colors fill-zinc-400 hover:fill-white">
  ...
  L341.91,330.654L341.91,330.654z"/>
                ...
                <li><a target="_blank" href="https://github.com/jakewalklate" className="hover:text-white transition-colors fill-zinc-400 hover:fill-white">
