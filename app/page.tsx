      ...
      <section className="w-full space-y-8 text-center sm:text-left py-12 border-b border-zinc-800/50">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl sm:text-3xl font-medium text-zinc-400">
            Life and Technology Specialist, Convergence & Ethics 
          </h2>
        ...
        <div className="flex flex-col gap-8 justify-between items-start">
          <div className="space-y-4 w-full">
            ...
            <div className="p-8 rounded-2xl bg-zinc-900/50 border border-white/5 hover:border-white/10 transition-colors group w-full">
              ...
              <p className="text-zinc-400 leading-relaxed">  
                Demonstration of the success of ethical engineering decision making as a unified framework for high-stakes systems manipulation and design.
              </p>
            </div>
          </div>
