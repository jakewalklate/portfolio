...
const albums = [
  { title: "Frogstomp", artist: "Silverchair", cover: "/frogstomp.jpg" },
  { title: "Hyperview", artist: "Title Fight", cover: "/hyperview.jpg" },
  { title: "Promise Everything", artist: "Basement", cover: "/promiseeverything.jpg" },
  { title: "Illmatic", artist: "Nas", cover: "/illmatic.jpg" },
  { title: "Shed", artist: "Title Fight", cover: "/shed.jpg" },
  { title: "Beside Myself", artist: "Basement", cover: "/besidemyself.jpg" },
  { title: "Youth", artist: "Citizen", cover: "/youth.jpg" },
  { title: "As You Please", artist: "Citizen", cover: "/asyouplease.jpg" },
  { title: "Peripheral Vision", artist: "Turnover", cover: "/pvision.jpg" },
  { title: "Colourmeinkindness", artist: "Basement", cover: "/kindness.jpg" },
  { title: "Nonstop Feeling", artist: "Turnstile", cover: "/nonstopfeeling.jpg" },
  { title: "36 Chambers", artist: "Wu-Tang Clan", cover: "/36chambers.jpg" },
  { title: "I Wish I Could Stay Here", artist: "Basement", cover: "/stay.jpg" },
  { title: "Dear G-D...", artist: "Being As An Ocean", cover: "/deargod.jpg" },
  { title: "Wildlife", artist: "La Dispute", cover: "/wildlife.jpg" },
  { title: "Floral Green", artist: "Title Fight", cover: "/floralgreen.jpg" },
  { title: "The Things We Think We're Missing", artist: "Balance and Composure", cover: "/weremissing.jpg" },
  { title: "Parachutes", artist: "Coldplay", cover: "/parachutes.jpg" },
  { title: "How We Both Wondrously Perish", artist: "Being As An Ocean", cover: "/howweboth.jpg" },
  { title: "Hybrid Theory", artist: "Linkin Park", cover: "/hybridtheory.jpg" },
      ...
      <section className="max-w-3xl w-full space-y-12">
        ...
        <div className="prose prose-invert prose-zinc max-w-none -mt-6">
          ...
          <p className="text-lg text-zinc-400 leading-relaxed mt-4">
            With a background in both life sciences and computer engineering, I bridge the gap between laboratory experimentation, engineering design, and technology development.
          </p>
        </div>
        ...
        {/* <div className="space-y-8 max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { title: "Maps of Meaning", author: "Dr Jordan Peterson", note: "The architecture of belief in human culture.", cover: "/mapsofmeaning.jpg" },
        ...
        {/* <div className="space-y-6">
          ...
          <div className="rounded-lg bg-[#0c0c0c] border border-white/5 hover:border-white/10 p-6 font-mono text-xs md:text-sm leading-relaxed text-zinc-400 shadow-2xl overflow-x-auto">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                <span className="text-zinc-600 shrink-0 text-xs my-0.5">[1882]</span>
                <span className="text-fuchsia-400 font-bold shrink-0">[DEBUG]</span>
              ...
              <div className="flex gap-3">
                ...
                <span className="text-zinc-300">"He who has a why can bear any how" — Friedrich Nietzsche</span>
              </div>
            </div>
          </div>
        </div> */}
                  ...
                  {[
                    ...
                    <div key={i} className="group">
                      <div className="flex justify-between text-sm mb-2">
                        ...
                        <span className="text-white">{trait.type} <span className="text-zinc-600">/</span> <span className="text-zinc-400">{trait.percent}%</span></span>
                      </div>
